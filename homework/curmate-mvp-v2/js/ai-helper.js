...
(function () {
  ...
  window.CURMATE_EXTRACT_SYSTEM_PROMPT =
    ...
    "กฎการแบ่งข้อ (สำคัญมาก ต้องทำเหมือนกันทุกครั้งไม่ว่าจะเรียกกี่รอบ): ให้ยึดตาม \"เลขข้อย่อยที่ลึกที่สุดที่มีอยู่จริงในเอกสาร\" " +
    "เป็น 1 กฎเกณฑ์เสมอ เช่น ถ้าเอกสารมีข้อ 9.2 ที่แตกเป็นข้อย่อย 9.2.1 9.2.2 9.2.3 9.2.4 ให้แยกเป็น 4 กฎเกณฑ์ " +
    "(1 ข้อย่อย = 1 กฎเกณฑ์) ห้ามรวมข้อย่อยหลายข้อเป็นกฎเกณฑ์เดียว และห้ามแตกข้อย่อยเดียวออกเป็นหลายกฎเกณฑ์เพิ่มเอง " +
    "ถ้าข้อใดไม่มีข้อย่อยเลย (เป็นข้อเดี่ยว) ให้ทั้งข้อนั้นเป็น 1 กฎเกณฑ์ " +
    "ข้อที่เป็นแค่นิยามศัพท์/คำอธิบายทั่วไปที่ตรวจสอบเป็นรูปธรรมไม่ได้ (เช่น หมวดนิยามคำศัพท์) ให้ข้ามไปไม่ต้องสกัด " +
